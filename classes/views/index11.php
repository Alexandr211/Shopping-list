...
<div id="wrapper" class="container-fluid">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href=#><?php include 'nick.php'; print ("Hi, ".$nick2); ?></a>
                    <a class="nav-item nav-link active" href="#">Home <span class="sr-only">(current)</span></a>
                    <a class="nav-item nav-link" href="../descr/index1">Description</a>
                    <a class="nav-item nav-link" href="../about/index1">About author</a>
                    <a class="nav-item nav-link" href="../main2">Logout</a>
  ...
  <input id = "spent" style="border: 0; color:#FF0000; font-weight:bold;" type="text" size="6" onmouseout="spentFunction()"> 
    ...
    <footer><?php //echo $_COOKIE ["q"]; ?></footer>
</div>
<a href="#" id=test></a>
</body>
